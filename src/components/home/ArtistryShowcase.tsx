...
export default function ArtistryShowcase() {
  ...
  return (
    <section ref={container} className="relative w-full bg-bridal-ivory py-32 lg:py-48 overflow-hidden">
      ...
      <div className="artistry-leaf absolute top-10 -left-20 w-125 h-125 z-0 pointer-events-none opacity-20 blur-sm mix-blend-multiply">
        <Image src="/leaves.webp" alt="" fill className="object-contain" />
      </div>
      <div className="artistry-leaf absolute bottom-10 -right-20 w-112.5 h-112.5 z-0 pointer-events-none opacity-20 blur-sm rotate-45 mix-blend-multiply">
        <Image src="/leaves.webp" alt="" fill className="object-contain" />
      </div>
      ...
      <div className="max-w-300 mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center relative z-10">
              ...
              {PROCESS_STEPS.map((step) => (
                <div key={step.id} className="flex gap-10 group">
                   <div className="relative flex flex-col items-center">
                      ...
                      <div className="w-px h-full bg-bridal-gold/10 group-hover:bg-bridal-gold/40 transition-all duration-500 mt-3" />
                   </div>
        ...
        <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
           <div ref={videoContainerRef} className="relative w-full max-w-lg aspect-9/14">
              ...
              {/* Museum Arched Frame */}
              <div className="relative w-full h-full rounded-t-4xl md:rounded-t-full rounded-b-[2.5rem] overflow-hidden shadow-[0_40px_80px_-15px_rgba(0,0,0,0.2)] border border-white/40 bg-bridal-ivory">
                <video
                  ref={videoRef}
                  playsInline
                  loop
                ...
                <div className="absolute bottom-12 right-10 bg-white/10 backdrop-blur-md border border-white/20 px-6 py-2.5 rounded-full">
                   <div className="flex items-center gap-3">
                      ...
                      <span className="font-sans text-[10px] uppercase tracking-[0.2em] text-white font-bold">Now Sculpting</span>
                   </div>
                </div>
              </div>
