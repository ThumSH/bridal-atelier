...
export default function HairEditorialHero() {
  ...
  return (
    <section ref={container} className="relative w-full h-[60vh] md:h-screen bg-bridal-ivory overflow-hidden flex items-center justify-center">
...
{/* --- THE TEXT OVERLAY --- */}
      ...
      <div ref={textRef} className="relative z-10 text-center text-white px-6 flex flex-col items-center">
         ...
         <h1 className="font-serif text-5xl md:text-9xl leading-[0.85] mb-8 drop-shadow-lg">
