...
export default function DeclarationsPage() {
  ...
  return (
    <main ref={container} className="relative min-h-screen bg-bridal-ivory pt-32 pb-24 overflow-hidden">
      ...
      {/* --- LAYER 1: DAPPLED LEAF SYSTEM (Enhanced Visibility) --- */}
      {/* Using mix-blend-multiply so shadows look realistic on the ivory background.
          Increased opacity and scale to ensure they fill the empty gutters.
      */}
      <div className="leaf-overlay absolute top-[2%] -left-32 w-[600px] h-[600px] z-20 pointer-events-none opacity-20 blur-md rotate-12 mix-blend-multiply">
        <Image src="/leaves.webp" alt="" fill className="object-contain" />
      </div>
      
      <div className="leaf-overlay absolute top-[20%] -right-40 w-[800px] h-[800px] z-20 pointer-events-none opacity-30 blur-[60px] -rotate-45 mix-blend-multiply">
        <Image src="/leaves.webp" alt="" fill className="object-contain" />
      </div>

      <div className="leaf-overlay absolute top-[40%] left-[-10%] w-[700px] h-[700px] z-20 pointer-events-none opacity-75 blur-xl rotate-90 mix-blend-multiply">
        <Image src="/leaves.webp" alt="" fill className="object-contain" />
      </div>

      <div className="leaf-overlay absolute top-[60%] right-[-10%] w-[600px] h-[600px] z-20 pointer-events-none opacity-50 blur-md -rotate-12 mix-blend-multiply">
        <Image src="/leaves.webp" alt="" fill className="object-contain" />
      </div>
      ...
      <div className="relative z-10">
        ...
        {/* --- FIXED HEADER TITLE --- */}
        <div className="max-w-[1300px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-40">
          <div className="reveal-item lg:col-span-5 pt-12">
            ...
            {/* Refined Title: Clean All-Caps Serif to match reference. 
                Adjusted leading and letter spacing for an editorial look.
            */}
          ...
          <div className="reveal-item lg:col-span-7 relative">
             <div className="relative h-[700px] rounded-[2rem] overflow-hidden shadow-2xl border border-white/40">
                <Image src={HEADER_IMAGE} alt="Bride" fill className="object-cover" priority />
             </div>
          </div>
        </div>

        {/* --- TIGHT COLLAGE GRID --- */}
        <div className="max-w-[1300px] mx-auto px-6 mb-40">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            
            {/* Column A */}
            <div className="flex flex-col gap-28">
              <div className="reveal-item max-w-sm border-l border-bridal-gold/30 pl-10">
                <p className="font-serif text-2xl md:text-3xl text-bridal-charcoal italic leading-relaxed">
                  &ldquo;{QUOTES[0].text}&rdquo;
                </p>
              </div>
              
              <div className="reveal-item relative w-full aspect-[3/4] rounded-[2.5rem] overflow-hidden shadow-xl border border-white/60">
                 <Image src={COLLAGE_IMAGES[1].src} alt="Portrait 1" fill className="object-cover" />
              </div>

              <div className="reveal-item relative w-[90%] aspect-square rounded-[2rem] overflow-hidden shadow-2xl ml-auto border border-white/60">
                 <Image src={COLLAGE_IMAGES[2].src} alt="Detail" fill className="object-cover" />
              </div>
            </div>

            {/* Column B */}
            <div className="flex flex-col gap-28 lg:pt-40">
              <div className="reveal-item relative w-full aspect-video rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/60">
                 <Image src={COLLAGE_IMAGES[0].src} alt="Landscape" fill className="object-cover" />
              </div>

              <div className="reveal-item flex flex-col md:flex-row items-center gap-12">
                 ...
                 <div className="relative w-full md:w-1/2 aspect-[3/4] rounded-[2rem] overflow-hidden shadow-xl border border-white/60">
                    <Image src={COLLAGE_IMAGES[3].src} alt="Portrait 2" fill className="object-cover" />
                 </div>
              </div>

              {/* p-9.webp Accent Image */}
              <div className="reveal-item relative w-[80%] aspect-[4/5] rounded-[2rem] overflow-hidden shadow-2xl mr-auto mt-4 border border-white/60">
                 <Image src={COLLAGE_IMAGES[4].src} alt="Accent" fill className="object-cover" />
              </div>
            </div>
        ...
        {/* --- FOCUS POINT --- */}
        <div className="reveal-item max-w-md mx-auto mb-48 px-6 text-center">
          <div className="relative aspect-[3/4] rounded-t-full rounded-b-[4rem] overflow-hidden shadow-2xl border-[16px] border-white">
             <Image src={CENTERED_BW_IMAGE} alt="Focus" fill className="object-cover grayscale" />
          </div>
      ...
      <div className="relative z-10 reveal-item max-w-6xl mx-auto px-6 mb-20 group">
        <div className="relative w-full h-[70vh] rounded-[4rem] overflow-hidden shadow-2xl border-[20px] border-white">
          <Image src={BIG_END_IMAGE} alt="Final" fill className="object-cover" />
          <div className="absolute inset-0 bg-black/5" />
        </div>
      </div>

      {/* --- NEW: SOCIAL MEDIA FOLLOW SECTION --- */}
      <div className="relative z-10 reveal-item flex flex-col items-center pb-32 px-6">
        
        {/* Decorative Divider Line */}
        <div className="w-px h-24 bg-gradient-to-b from-bridal-gold to-transparent mb-12" />
